    ...
    private fun listenAllIssues() {
        ...
        issuesListener = firestore.collection("all_issues")
            ...
            .addSnapshotListener { snap, err ->
                ...
                if (err != null) {
                    showAppToast(err.message ?: "Something went wrong.")
...
private class AdminIssueAdapter(
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        val priorityBand = PriorityBands.fromScore(issue.priorityScore)

        holder.tvPriority.visibility = View.VISIBLE
        holder.tvPriority.text = "Priority: ${priorityBand.label}"
        holder.tvPriority.setTextColor(ContextCompat.getColor(context, priorityBand.colorRes))
